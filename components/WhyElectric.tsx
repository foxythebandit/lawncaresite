export default function WhyElectric() {
  return (
    <section className="why" id="why">
      <div className="section-label reveal">Why electric</div>
      <h2 className="section-h2 reveal" data-delay="80">Better for you.<br />Better for the planet.</h2>
      <p className="section-sub reveal" data-delay="160">Gas crews are loud, polluting, and increasingly banned. We built the alternative.</p>
      <div className="why-grid">
        <div className="why-card reveal" data-delay="0">
        ...
        <div className="why-card reveal" data-delay="120">
          <div className="why-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="why-card reveal" data-delay="240">
          <div className="why-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="why-card reveal" data-delay="360">
          <div className="why-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
